...
(function ($) {
  ...
  var methods = {
    init: function (options) {
       ...
       * @type {object}
       */      
      // L&L modified: array um eine Dimension erweitert, damit nicht ganze Spalten, sondern einzelne Zellen adressiert werden    
      var Draw = {
        columns: {
          identifier: function () {
            ...
            for (var j = 0; j < settings.columns.editable.length; j++){
              ...
              for (var i = 0; i < settings.columns.editable[j].length; i++) {
                ...
                $td.each(function () { 
                  ...
                  var input;
                  var sVisibleStart= "none;";
                  sVisibleStart= "visible;";
                  ...
                  switch (columnType) {
                    case 'input':
                      ...
                      input = '<input class="tabledit-input ' + settings.inputClass + '" type="text" name="' + settings.columns.editable[j][i][1] + '" value="' + text + '" style="display: ' + sVisibleStart + '"; disabled>';
                      //}
                      break;
                    case 'hidden':

                      // Create text input element.
                      input = '<input class="tabledit-input ' + settings.inputClass + '" type="hidden" name="' + settings.columns.editable[j][i][1] + '" value="' + text + '" style="display: ' + sVisibleStart + '"; disabled>';

                      break;
                    case 'number':

                      // Create text input element.
                      input = '<input class="tabledit-input ' + settings.inputClass + '" type="number" name="' + settings.columns.editable[j][i][1] + '" value="' + text + '" style="display: ' + sVisibleStart + '"; disabled>';
                    ...
                    case 'checkbox':
                      ...
                      sVisibleStart= "visible";
                      // Create text input element.
                      if (AnyToBool(text)==true)
                        input = '<input class="tabledit-input ' + settings.inputClass + '" type="checkbox" name="' + settings.columns.editable[j][i][1] + '" value="' + text + '" style="display: ' + sVisibleStart + '"; checked>'+ '&nbsp;'+text;
                      else
                        input = '<input class="tabledit-input ' + settings.inputClass + '" type="checkbox" name="' + settings.columns.editable[j][i][1] + '" value="' + text + '" style="display: ' + sVisibleStart + '"; disabled>'+ '&nbsp;'+text;

                      //input = '<input class="tabledit-input ' + settings.inputClass + '" type="checkbox" name="' + settings.columns.editable[j][i][1] + '" value="' + text + '" style="display: none;" disabled>';
                    ...
                    case 'date':
                      ...
                      // Create text input element.
                      input = '<input class="tabledit-input ' + settings.inputClass + '" type="date" name="' + settings.columns.editable[j][i][1] + '" value="' + text + '" style="display: ' + sVisibleStart + '"; disabled>';
       ...
       */
        ...
        view: function (td) {
          ...
          // Hide and disable input element.
          //xxx $(td).find('.tabledit-input').blur().hide().prop('disabled', true);
          // Hide count if exist for textarea
          //$(td).find('.count_').hide();
          // Hide span element.
          ...
          // Add "view" class and remove "edit" class in td element.
          //xxx $(td).addClass('tabledit-view-mode').removeClass('tabledit-edit-mode');
          ...
          $(td).each(function () {
            ...
            if ($input.is('select')) {
              ...
              if ($(this).find( "[type=checkbox]" ).length>0){
                $(this).find('.tabledit-span').text($(this).find( "[type=checkbox]" )[0].checked);
              }else {
